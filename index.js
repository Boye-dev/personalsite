...
if (hours >=0&&hours<12 ) {
  ...
  $(".navbar-toggler").on("click",function(){
    $("nav").css("background-color","#053742");
  });
  ...
  $(".bio-loc").removeClass("bio");
  $(".bio-loc").addClass("bio-morning");
...
$(".navbar-toggler").on("click",function(){
  $("nav").css("background-color","rgba(85.5, 0, 21.6, 0.99)");
});
...
typewriter
  ...
  .pauseFor(200)
  .deleteChars(14)
  .typeString('<strong>Pythoneer</strong>')
  .pauseFor(1000)
  .deleteChars(10)
